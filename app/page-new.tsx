              ...
              {[
                {
                  ...
                  description:
                    'Create a credential with multiple claims (name, degree, date, etc.)',
                },
                {
                  step: '2',
                  title: 'Select Fields',
                  description:
                    'Choose which fields to disclose to a specific verifier',
                },
                {
                  step: '3',
                  title: 'Generate Proof',
                  description:
                    'System creates a verifiable presentation with cryptographic proof',
                },
                {
                  step: '4',
                  title: 'Share Link',
                  description:
                    'Share via QR code or link - verifiers can instantly confirm authenticity',
                },
              ].map(item => (
